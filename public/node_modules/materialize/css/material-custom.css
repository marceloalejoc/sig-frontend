@font-face {
    ...
    src: url(../font/material-design-icons/Material-Design-Icons.eot?3ocs8m);
    src: url(../font/material-design-icons/Material-Design-Icons.eot?#iefix3ocs8m) format('embedded-opentype'), url(../font/material-design-icons/Material-Design-Icons.woff?3ocs8m) format('woff'), url(../font/material-design-icons/Material-Design-Icons.ttf?3ocs8m) format('truetype'), url(../font/material-design-icons/Material-Design-Icons.svg?3ocs8m#Material-Design-Icons) format('svg');
    font-weight: 400;
    font-style: normal
}
...
body .well-warning {
    background-color: rgba(54, 22, 24, .77)
}
...
body .well-danger {
    background-color: rgba(185, 74, 72, .54)
}
...
.btn-warning.btn-flat:not(.btn-link) {
    color: rgba(54, 22, 24, .77)
}

.btn-danger.btn-flat:not(.btn-link) {
    color: rgba(185, 74, 72, .54)
}
...
.btn-warning:hover:not(.btn-link):not(.btn-flat) {
    background-color: rgba(68, 28, 30, .77)
}

.btn-danger:hover:not(.btn-link):not(.btn-flat) {
    background-color: rgba(191, 89, 87, .54)
}
...
.btn-warning:active:not(.btn-link):not(.btn-flat) {
    background-color: rgba(76, 31, 34, .77)
}

.btn-danger:active:not(.btn-link):not(.btn-flat) {
    background-color: rgba(193, 96, 94, .54)
}
...
.btn.btn-flat:hover:not(.btn-ink) {
    background-color: rgba(214, 208, 208, .2)
}
...
.btn-primary.btn-flat:hover:not(.btn-ink) {
    background-color: rgba(134, 115, 116, .2)
}
...
.btn-info.btn-flat:hover:not(.btn-ink) {
    background-color: rgba(206, 193, 193, .2)
}

.btn-warning.btn-flat:hover:not(.btn-ink) {
    background-color: rgba(54, 22, 24, .2)
}

.btn-danger.btn-flat:hover:not(.btn-ink) {
    background-color: rgba(185, 74, 72, .2)
}
...
.togglebutton-default label input[type=checkbox]:checked+.toggle {
    background-color: rgba(134, 115, 116, .5)
}
...
.togglebutton-default label input[type=checkbox]:checked+.toggle:active:after {
    box-shadow: 0 1px 3px 1px rgba(0, 0, 0, .4), 0 0 0 15px rgba(134, 115, 116, .1)
}
...
.togglebutton-info label input[type=checkbox]:checked+.toggle:active:after {
    box-shadow: 0 1px 3px 1px rgba(0, 0, 0, .4), 0 0 0 15px rgba(206, 193, 193, .1)
}

.togglebutton-warning label input[type=checkbox]:checked+.toggle:active:after {
    box-shadow: 0 1px 3px 1px rgba(0, 0, 0, .4), 0 0 0 15px rgba(54, 22, 24, .1)
}

.togglebutton-danger label input[type=checkbox]:checked+.toggle:active:after {
    box-shadow: 0 1px 3px 1px rgba(0, 0, 0, .4), 0 0 0 15px rgba(185, 74, 72, .1)
}
...
.togglebutton-material-yellow label input[type=checkbox]:checked+.toggle:active:after {
    box-shadow: 0 1px 3px 1px rgba(0, 0, 0, .4), 0 0 0 15px rgba(255, 235, 59, .1)
}
...
.radio-warning input[type=radio]:checked~.circle {
    border-color: rgba(54, 22, 24, .77)
}

.radio-danger input[type=radio]:checked~.circle {
    border-color: rgba(185, 74, 72, .54)
}
...
.form-control {
    border: 0;
    background-image: linear-gradient(#867374, #867374), linear-gradient(#d2d2d2, #d2d2d2);
...
.form-control-wrapper .form-control:invalid {
    background-image: linear-gradient(rgba(185, 74, 72, .54), rgba(185, 74, 72, .54)), linear-gradient(#d2d2d2, #d2d2d2)
}
...
.form-group.has-warning .material-input:focus {
    background-image: linear-gradient(rgba(54, 22, 24, .77), rgba(54, 22, 24, .77)), linear-gradient(#d2d2d2, #d2d2d2);
    box-shadow: none
}
...
.form-group.has-info .material-input:focus {
    background-image: linear-gradient(#cec1c1, #cec1c1), linear-gradient(#d2d2d2, #d2d2d2);
    box-shadow: none
}
